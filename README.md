[![OpenSSF Scorecard](https://api.securityscorecards.dev/projects/github.com/instil/figma-sync/badge)](https://securityscorecards.dev/viewer/?uri=github.com/{owner}/{repo})
